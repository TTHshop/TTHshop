                ...
                <table class="table table-bordered data-table">
                    ...
                    @foreach($products as $product)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="vertical-align: middle;text-align: center;"><a href="{{route('image-gallery.show',$product->id)}}" class="btn btn-default btn-mini">Thêm ảnh</a></td>
                            ...
                            <td style="text-align: center; vertical-align: middle;">
                                ...
                                <a href="{{route('product.edit',$product->id)}}" class="btn btn-primary btn-mini">Sửa</a>
