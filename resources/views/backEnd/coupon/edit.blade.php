...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Trang chủ</a> <a href="{{route('coupon.index')}}">Coupons</a> <a href="#" class="current">Sửa Coupon</a> </div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="{{route('coupon.update',$edit_coupons->id)}}" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="amount_type" class="control-label">đơn vị tiền</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success">Cập nhật Coupon</button>
                        </div>
                    </div>
                </form>
            </div>
