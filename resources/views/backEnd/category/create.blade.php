...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Trang chủ</a> <a href="{{route('category.index')}}">Danh mục</a> <a href="{{route('category.create')}}" class="current">Thêm mới danh mục</a> </div>
